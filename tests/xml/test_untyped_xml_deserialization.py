...
from jetblack_serialization.xml.untyped_xml_deserializer import deserialize_untyped_xml
...
def test_untyped_xml_serialization_list():
    ...
    list_int_obj = deserialize_untyped_xml(list_int_text, config)
...
def test_untyped_xml_serialization_dict():
    ...
    obj = deserialize_untyped_xml(text, config)
    assert obj == {
        'int': 42,
        'str': 'a string',
        'list': [1, 2, 3],
